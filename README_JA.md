...
| 左クリック | 押し潰されて弾む反動 + 弾幕 1 重発射 |
| 左ダブルクリック | 反動 2 回 + 弾幕 2 セット（計 4 重） |
| 右ドラッグ左右 | 向きを回転 |
...
- **散歩モード**: 現在の位置から始まり、画面左右を往復してお散歩、軽いジャンプ付き; ドラッグや回転で停止
- **その場回転**: とてもゆっくりその場で回転し、普段どおり瞬きしながら数秒ごとに小さな弾幕を一重放つ; 散歩モードとは排他
...
そして**東方ファンの皆さん**にも感謝します——本当に偉大で素敵な仲間たちです。みなさん繊細で温かく、同人作品と愛で幻想郷をどんどん大きく紡いでいっています。この輪の中にいられること自体が、このペットが生まれた理由のひとつです。
